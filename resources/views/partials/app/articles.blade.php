<div class="row">
    <div class="col-12">
        ...
        <div class="newest-article mb-5">
            <div class="textbox ">
                <h3 class="f-sbold">{{ $articles[0]->title }}</h3>
                <div class="f-med">{{ getNWords($articles[0]->content, 50) }}</div>
                <div class="f-med">Kategori : {{ $articles[0]->category->title }}</div>
            </div>
            <img src="{{ URL::asset($articles[0]->image) }}" class="w-100 img-fluid" />
        </div>
